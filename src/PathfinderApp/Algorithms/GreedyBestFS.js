...
// Heuristic used by the Greedy Best First Search Algorithm
...
const GreedyBestFS = function(start_i, start_j, end_i, end_j, rows) {
    const startNode = new Node(start_i, start_j, 0, getManhattanDist(start_i, start_j, end_i, end_j), null);  // i, j, g, h, parent
    const heap = new Heap([startNode], null, (node1, node2) => node2.h - node1.h);
